...
func main() {
	...
	app.Flags = []cli.Flag{
		...
		&cli.StringFlag{
			...
			FilePath: string("/vela/secrets/parameter/config/server,/vela/secrets/downstream/config/server"),
			Name:     "config.server",
			Usage:    "Vela server to authenticate with",
		},
		&cli.StringFlag{
			EnvVars:  []string{"PARAMETER_TOKEN", "CONFIG_TOKEN", "VELA_TOKEN", "DOWNSTREAM_TOKEN"},
			FilePath: string("/vela/secrets/parameter/config/token,/vela/secrets/downstream/config/token"),
			Name:     "config.token",
		...
		&cli.StringFlag{
			...
			FilePath: string("/vela/secrets/parameter/repo/branch,/vela/secrets/downstream/repo/branch"),
			Name:     "repo.branch",
		...
		&cli.StringSliceFlag{
			...
			FilePath: string("/vela/secrets/parameter/repo/names,/vela/secrets/downstream/repo/names"),
			Name:     "repo.names",
