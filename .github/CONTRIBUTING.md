...
```bash
# Clone the project
git clone git@github.com:go-vela/vela-downstream.git $HOME/go-vela/vela-downstream
```
...
cd $HOME/go-vela/vela-downstream
```
...
git remote add fork https://github.com/your_fork/vela-downstream
```
